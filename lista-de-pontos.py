#Atividade - Lista de pontos
#Esse programa lê um as coordenadas de pontos de um polígono e desenha o polígono como forma de verificar visualmente os dados lidos.
...
def verificaColisao(x,y,pt,convexo):
  ...
  #se o polígono for convexo, verifico o produto vetorial entre P(i-1).P(i) e pt.(i)
  if convexo == True:
  ...
  #se o polígono for côncavo, mudo a ordem do produto vetorial: pt.P(i) e P(i-1).P(i)
  else:
    for i in range(1, len(x)):
